                    ...
                    <div class="card-body">
                        <div class="clearfix">
                            ...
                            <div class="float-right text-right">
                                ...
                                <h4>{{$teacherStudentsCount}}</h4>
                            </div>
                        </div>
                        <p class="text-muted pt-3 mb-0 mt-2 border-top">
                            <i class="fas fa-binoculars mr-1" aria-hidden="true"></i>
                            <a href="{{route('teacher.students.show')}}" target="_blank">
                                <span class="text-danger">عرض الطلاب</span>
                            </a>
                        </p>
                    </div>
                </div>
                    ...
                    <div class="card-body">
                        <div class="clearfix">
                            ...
                            <div class="float-right text-right">
                                ...
                                <h4>{{$teacherSectionsCount}}</h4>
                            </div>
                        </div>
                        <p class="text-muted pt-3 mb-0 mt-2 border-top">
                            <i class="fas fa-binoculars mr-1" aria-hidden="true"></i>
                            <a href="{{route('teacher.sections.show')}}" target="_blank">
