                                    ...
                                    <table id="datatable" class="table  table-hover table-sm table-bordered p-0"
                                        ...
                                        @foreach($quizzes as $quizze)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{route('exams.edit',$quizze->id)}}"
                                                    ...
                                                    <a href="{{route('student.degree',$quizze->id)}}"
                                                       class="btn btn-success btn-sm" title="عرض درجات الطلاب" role="button" aria-pressed="true"><i
                                                            class="fa-duotone fa-award"></i></a>
