    ...
    <form method="post" action="{{ route('attendance') }}" autocomplete="off">
        ...
        <table id="datatable" class="table  table-hover table-sm table-bordered p-0" data-page-length="50"
            ...
            <tr>
                ...
                <th class="alert-success">{{ __('Students_trans.name') }}</th>
                <th class="alert-success">{{ __('Students_trans.email') }}</th>
                <th class="alert-success">{{ __('Students_trans.gender') }}</th>
                <th class="alert-success">{{ __('Students_trans.Grade') }}</th>
                <th class="alert-success">{{ __('Students_trans.classrooms') }}</th>
                <th class="alert-success">{{ __('Students_trans.section') }}</th>
        ...
        <P>
            <button class="btn btn-success" type="submit">{{ __('Students_trans.submit') }}</button>
        </P>
    </form><br>
    <!-- row closed -->
@endsection
