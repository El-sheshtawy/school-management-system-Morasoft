<div class="scrollbar side-menu-bg" style="overflow: scroll">
    <ul class="nav navbar-nav side-menu" id="sidebarnav">
        ...
        <!-- الاقسام-->
        <li>
            <a href="{{route('teacher.sections.show')}}"><i class="fas fa-chalkboard"></i><span
                    class="right-nav-text">الاقسام</span></a>
        </li>

        <!-- الطلاب-->
        <li>
            <a href="{{route('teacher.students.show')}}"><i class="fas fa-user-graduate"></i><span
        ...
        <li>
            ...
            <ul id="sections-menu" class="collapse" data-parent="#sidebarnav">
                <li><a href={{route('exams.index')}}>الامتحانات</a></li>
            </ul>
